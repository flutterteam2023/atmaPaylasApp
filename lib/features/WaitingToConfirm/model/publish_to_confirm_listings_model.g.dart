...
_$PublishToConfirmListingsModelImpl
    _$$PublishToConfirmListingsModelImplFromJson(Map<String, dynamic> json) =>
        _$PublishToConfirmListingsModelImpl(
          id: json['id'] as int,
...
Map<String, dynamic> _$$PublishToConfirmListingsModelImplToJson(
        _$PublishToConfirmListingsModelImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
      'user': instance.user,
