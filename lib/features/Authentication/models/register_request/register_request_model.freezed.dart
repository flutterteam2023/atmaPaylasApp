...
class _$RegisterRequestModelImpl implements _RegisterRequestModel {
  ...
  @override
  String toString() {
    return 'RegisterRequestModel(email: $email, username: $username, password: $password, confirmation: $confirmation, name: $name, surname: $surname, phoneNumber: $phoneNumber, userLocatedCity: $userLocatedCity, userLocatedDistrict: $userLocatedDistrict)';
  }
